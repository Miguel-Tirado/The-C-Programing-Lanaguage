/*
 * Exercise 2.1    Miguel Tirado
 * Program to print maximum, minimum limits of char,int, long using
 * Calulcations 
 *
 * The Logic used is 
 * ~0 will give you bits in 1s. ~0 is the same as zeros compliment
 * (unsigned <type>) will cast it unsiged 
...
int main(void) {
	/* ranges of varous floating point types through calculations */
	/* Note these calculations were done to solve the */
